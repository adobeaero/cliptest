...
/*!**************************************************************************************************************************************!*\
  !*** /Users/falco/Documents/Source/Aero-app/aero-babylon/babylon_js/dist/git/adobe/Aero/BabylonAero/node_modules/tslib/tslib.es6.js ***!
  \**************************************************************************************************************************************/
...
/***/ "./Aero/aeroFileLoader.ts":
/*!********************************!*\
  !*** ./Aero/aeroFileLoader.ts ***!
  \********************************/
/*! exports provided: AeroFileLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroFileLoader", function() { return AeroFileLoader; });
/* harmony import */ var babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs/Loading/sceneLoader */ "babylonjs/Maths/math.color");
...
/* harmony import */ var _format_aeroPublishHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./format/aeroPublishHelper */ "./Aero/format/aeroPublishHelper.ts");
/* harmony import */ var _format_aeroScene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./format/aeroScene */ "./Aero/format/aeroScene.ts");
...
var AeroFileLoader = /** @class */ (function () {
    ...
    function AeroFileLoader(loadingOptions) {
         ...
         */
        this.extensions = ".aero";
        this._assetContainer = null;
        //Publish
        this.publish = new _format_aeroPublishHelper__WEBPACK_IMPORTED_MODULE_1__["AeroPublishHelper"]();
        this.savedPublishURL = "";
        this._loadingOptions = loadingOptions || AeroFileLoader.DefaultLoadingOptions;
    }
    AeroFileLoader.prototype.LoadAeroWebScene = function (url, cpURL, componentMap, onProgress) {
        var _this = this;
        var options = new Object();
        options.componentMap = componentMap;
        if (!this.sceneLoadedPromise) {
            this.sceneLoadedPromise = new Promise(function (resolve, reject) {
                _this.scene.SetSceneLoadedCallback(function (meshes) {
                    resolve(meshes);
                });
            });
        }
        if ((cpURL != undefined && cpURL.includes("CP_URL")) ||
            ...
            this.publish.LoadAeroManifest(url, cpURL, function (theURL, cmap) {
                _this.LoadAeroWebScene(theURL, cpURL, cmap, onProgress);
            });
        }
        else {
            //This scene has a web viewer - load in the JS, eval it and then run the viewer
            if (onProgress) {
                this.SetProgressCallback(function (isValid, done, total) {
                    onProgress({
            ...
            return this.sceneLoadedPromise.then(function () {
                return _this.scene.GetLoadedMeshes();
            });
        }
    ...
    AeroFileLoader.prototype.Initialize = function () {
        //Set up and scene loading callback for preprocessing
        this.scene.InitializeSceneLoader();
    };
    AeroFileLoader.prototype.Start = function () {
        this.scene.Start();
    };
    AeroFileLoader.prototype.SetProgressCallback = function (callback) {
        this.scene.progressCallback = callback;
    };
    Object.defineProperty(AeroFileLoader, "DefaultLoadingOptions", {
        get: function () {
            return {
     ...
     */
    AeroFileLoader.prototype.createPlugin = function () {
     ...
     */
    AeroFileLoader.prototype.canDirectLoad = function (data) {
        return false;
    };
    /**
     ...
     */
    AeroFileLoader.prototype.importMeshAsync = function (meshesNames, scene, data, rootUrl, onProgress, fileName) {
        if (onProgress) {
            this._progressCallback = onProgress;
        }
        //get the meshes from Aero file
        return this._parseAeroFile(meshesNames, scene, data, rootUrl).then(function (meshes) {
            return {
                meshes: meshes,
                particleSystems: [],
                skeletons: [],
     ...
     */
    AeroFileLoader.prototype.loadAsync = function (scene, data, rootUrl, onProgress, fileName) {
        //Get the 3D model
     ...
     */
    AeroFileLoader.prototype.loadAssetContainerAsync = function (scene, data, rootUrl, onProgress, fileName) {
        var _this = this;
     ...
     */
    AeroFileLoader.prototype._parseAeroFile = function (meshesNames, scene, data, rootUrl) {
        this.scene = new _format_aeroScene__WEBPACK_IMPORTED_MODULE_2__["AeroScene"](scene);
        var url = rootUrl;
        if (url[url.length - 1] == '/') {
        ...
        return this.LoadAeroWebScene(url, "", componentMap, this._progressCallback).then(function (meshes) {
            return meshes;
        });
    };
    /**
     ...
     */
    AeroFileLoader.AUTO_PLAY = true;
    return AeroFileLoader;
}());

if (babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__["SceneLoader"]) {
    //Add this loader into the register plugin
    babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__["SceneLoader"].RegisterPlugin(new AeroFileLoader());
}


/***/ }),

/***/ "./Aero/aeroLoadingOptions.ts":
/*!************************************!*\
  !*** ./Aero/aeroLoadingOptions.ts ***!
  \************************************/
/*! no exports provided */
...
/***/ "./Aero/format/aeroAnchorNode.ts":
/*!***************************************!*\
  !*** ./Aero/format/aeroAnchorNode.ts ***!
  \***************************************/
/*! exports provided: AeroAnchorNode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroAnchorNode", function() { return AeroAnchorNode; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
/* harmony import */ var babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babylonjs/Meshes/transformNode */ "babylonjs/Maths/math.color");
...
var AeroAnchorNode = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(AeroAnchorNode, _super);
    function AeroAnchorNode(name, scene, aeroScene) {
        var _this = _super.call(this, name, scene) || this;
        //Horizontal or Vertical (1/2)
        _this.desiredAlignment = 1;
        //Filled in if anchor is an image anchor
        _this.imageMarkerPath = ""; //"imageMarker.filename"
        _this.physicalWidth = 0;
        _this.aeroScene = aeroScene;
        return _this;
    }
    return AeroAnchorNode;
}(babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_1__["TransformNode"]));



/***/ }),

/***/ "./Aero/format/aeroAsset.ts":
/*!**********************************!*\
  !*** ./Aero/format/aeroAsset.ts ***!
  \**********************************/
/*! exports provided: AeroBoundingBox, AeroAsset */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroBoundingBox", function() { return AeroBoundingBox; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroAsset", function() { return AeroAsset; });
...
var AeroBoundingBox = /** @class */ (function () {
    function AeroBoundingBox() {
        this.min = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
        this.max = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
    }
    return AeroBoundingBox;
}());

var AeroAsset = /** @class */ (function () {
    function AeroAsset(entity_i) {
        this.m_maxDiameter = 1;
        this.m_uri = "";
        this.entity = entity_i;
    }
    AeroAsset.prototype.bounds = function () {
        if (this.m_bounds) {
            return this.m_bounds;
        }
        else {
            return { min: new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0), max: new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0) };
        }
    };
    AeroAsset.prototype.maxDiameter = function () {
    ...
    AeroAsset.prototype.uri = function () {
        return this.m_uri;
    };
    AeroAsset.prototype.setBounds = function (bounds) {
        this.m_bounds = bounds;
    };
    AeroAsset.prototype.setMaxDiameter = function (maxDiameter) {
        this.m_maxDiameter = maxDiameter;
    };
    AeroAsset.prototype.setUri = function (uri) {
        this.m_uri = uri;
    };
    return AeroAsset;
}());
...
/***/ "./Aero/format/aeroBehaviorEngine.ts":
/*!*******************************************!*\
  !*** ./Aero/format/aeroBehaviorEngine.ts ***!
  \*******************************************/
/*! exports provided: RTMCustomBehaviorPrototype, AeroBehaviorEngineWASM, AeroBehaviorEngine, AeroVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RTMCustomBehaviorPrototype", function() { return RTMCustomBehaviorPrototype; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroBehaviorEngineWASM", function() { return AeroBehaviorEngineWASM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroBehaviorEngine", function() { return AeroBehaviorEngine; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroVideo", function() { return AeroVideo; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
...
var RTMCustomPropertyPrototype = /** @class */ (function () {
    function RTMCustomPropertyPrototype(name) {
        this.name = name;
    }
    RTMCustomPropertyPrototype.prototype.setString = function (value) {
        this.value = value;
    };
    RTMCustomPropertyPrototype.prototype.getName = function () {
        return this.name;
    };
    RTMCustomPropertyPrototype.prototype.getValue = function () {
        return this.value;
    };
    return RTMCustomPropertyPrototype;
}());
var AeroCustomAction = /** @class */ (function () {
    function AeroCustomAction(params, proto) {
        this.params = params;
        this.customActionPrototype = proto;
    }
    AeroCustomAction.prototype.Start = function (params) {
        return this.customActionPrototype.Start(this.params);
    };
    AeroCustomAction.prototype.Update = function (params) {
        return this.customActionPrototype.Update(this.params);
    };
    return AeroCustomAction;
}());
var RTMCustomActionPrototype = /** @class */ (function () {
    function RTMCustomActionPrototype() {
        this.onStart = null;
        this.onUpdate = null;
    }
    RTMCustomActionPrototype.prototype.setName = function (name) {
        this.name = name;
    };
    RTMCustomActionPrototype.prototype.getName = function () {
        return this.name;
    };
    RTMCustomActionPrototype.prototype.property = function (name) {
        return new RTMCustomPropertyPrototype(name);
    };
    RTMCustomActionPrototype.prototype.setOnStart = function (onStart) {
        this.onStart = onStart;
    };
    RTMCustomActionPrototype.prototype.setOnUpdate = function (onUpdate) {
        this.onUpdate = onUpdate;
    };
    RTMCustomActionPrototype.prototype.Start = function (params) {
        if (!this.onStart) {
            return;
        }
        var result = this.onStart(params);
        return result;
    };
    RTMCustomActionPrototype.prototype.Update = function (params) {
        if (!this.onUpdate) {
            return;
        }
        var result = this.onUpdate(params);
        return result;
    };
    RTMCustomActionPrototype.prototype.instance = function (params) {
        var instance = new AeroCustomAction(params, this);
        return instance;
    };
    return RTMCustomActionPrototype;
}());
//This class is a singleton that is used to keep track of all instanced custom behaviors
var RTMCustomBehaviorPrototype = /** @class */ (function () {
    function RTMCustomBehaviorPrototype() {
        this.scene = new Object();
        this.customActionPrototypes = new Map();
        this.scene.behaviorPrototype = this;
        this.scene.addActionPrototype = function (aeroProtoAction) {
            this.behaviorPrototype.AddActionPrototype(aeroProtoAction);
        };
    }
    RTMCustomBehaviorPrototype.prototype.GetActionPrototype = function (name) {
        if (this.customActionPrototypes.has(name)) {
            var Prototype = this.customActionPrototypes.get(name);
    ...
    RTMCustomBehaviorPrototype.prototype.AddActionPrototype = function (uiAction) {
        this.customActionPrototypes.set(uiAction.getName(), uiAction);
    };
    RTMCustomBehaviorPrototype.prototype.Action = function () {
        return new RTMCustomActionPrototype();
    };
    return RTMCustomBehaviorPrototype;
}());

/** @hidden */
var AeroBehaviorEngineWASM = /** @class */ (function () {
    function AeroBehaviorEngineWASM(scene, behaviorEngine) {
        this._aero = null;
        this.customActionInstances = new Map();
        this.prefix = "./";
    ...
    AeroBehaviorEngineWASM.prototype.initAeroBehaviorEngineWASM = function (aeroBehaviorEngineOptions, engineInitializedCallback) {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        aeroBehaviorEngineOptions = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, AeroBehaviorEngineWASM._aeroBehaviorEngineOptions), aeroBehaviorEngineOptions);
                        ...
                        if (!(aeroBehaviorEngineOptions.jsPath && aeroBehaviorEngineOptions.wasmPath)) return [3 /*break*/, 3];
                        jsPath = aeroBehaviorEngineOptions.jsPath;
                        if (typeof WebAssembly === 'undefined') {
                            console.log("Web Assembly not available.  Trying asm.js...");
                            jsPath = aeroBehaviorEngineOptions.asmPath;
                        }
                        if (!Object(babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["IsWindowObjectExist"])()) return [3 /*break*/, 2];
                        return [4 /*yield*/, babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Tools"].LoadScriptAsync(jsPath)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 3:
                        if (typeof Module !== 'undefined') {
                            ...
                            this._aero['onRuntimeInitialized'] = function () {
                                _this._aero['SetVector3WASMCallback'] = function (nodeName, propertyName, x, y, z) {
                                    if (nodeName == "") {
                                        return;
                                    }
                                    var node = _this.babylonScene.getNodeById(nodeName);
                                    if (node) {
                                ...
                                _this._aero['SetVector4WASMCallback'] = function (nodeName, propertyName, r, g, b, a) {
                                ...
                                _this._aero['SetQuaternionWASMCallback'] = function (nodeName, propertyName, x, y, z, w) {
                                    if (nodeName == "") {
                                        return;
                                    }
                                    var node = _this.babylonScene.getNodeById(nodeName);
                                    if (node) {
                                        var theQuat = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Quaternion"](x, y, z, w);
                                        node[propertyName] = theQuat;
                                    }
                                    //console.log("SetQuaternionWASMCallback: " + nodeName + "," + propertyName + "," + x  + ","+y + ","+z + ","+w);
                                };
                                _this._aero['SetVisibilityWASMCallback'] = function (nodeName, propertyName, value) {
                                    if (nodeName == "") {
                                        return;
                                    }
                                    var node = _this.babylonScene.getNodeById(nodeName);
                                ...
                                _this._aero['SendCommandWASMCallback'] = function (command, commandData) {
                                    var result = new Object();
                                    var params = JSON.parse(commandData);
                                    if (command == "openURL") {
                                        _this.behaviorHandler.doOpenURL(params);
                                    }
                                    else if (command == "playAnimation") {
                                        _this.behaviorHandler.doPlayAnimation(params);
                                    }
                                    else if (command == "getAudioClipDuration") {
                                        var sound = _this.behaviorHandler.getSoundForAction(params);
                                        if (sound) {
                                            if (sound.getAudioBuffer()) {
                                                var buffer = sound.getAudioBuffer();
                                        ...
                                        if (AeroBehaviorEngine.customBehaviorRTMPrototype == null) {
                                            ...
                                            var customActionPrototype = AeroBehaviorEngine.customBehaviorRTMPrototype.GetActionPrototype(params.name);
                                            if (customActionPrototype) {
                                                if (command == "startCustomAction") {
                                                    ...
                                                    if (result.status == "running") {
                                                        _this.customActionInstances.set(AeroBehaviorEngineWASM.actionID, newAction);
                                                        result.actionID = AeroBehaviorEngineWASM.actionID++;
                                                    }
                                                }
                                                else if (command == "updateCustomAction") {
                                                    if (_this.customActionInstances.has(params.actionID)) {
                                                        var actionInstance = _this.customActionInstances.get(params.actionID);
                                                        if (actionInstance) {
                                                            try {
                                ...
                                _this._aero['SendEventWASMCallback'] = function (command, commandData) {
                                    if (command == "") {
                                        return;
                                    }
                                    //console.log("SendEventWASMCallback: " + command + "," + commandData);
                                };
                                engineInitializedCallback(_this._aero.AeroBehaviorEngine);
                            };
    ...
    AeroBehaviorEngineWASM.actionID = 0;
    return AeroBehaviorEngineWASM;
}());

var AeroAction = /** @class */ (function () {
    function AeroAction() {
        this.infinite = false;
    }
    return AeroAction;
}());
var AeroBehavior = /** @class */ (function () {
    function AeroBehavior() {
    }
    AeroBehavior.prototype.setParent = function (parent) {
        if (parent) {
            this.parent = parent;
...
var AeroBehaviorEngine = /** @class */ (function () {
    function AeroBehaviorEngine(scene) {
        /*
            TODO: make example C++ code:
            - Put in the 4 entry points
            - Call back handleAction: port behavior engine below
        */
        this.useWASM = true; //Flip this switch to use the WASM class
        this.rawBehaviors = new Array();
        this.tapBehaviors = new Map();
        this.proximityBehaviors = new Map();
        this.startBehaviors = new Array();
        //Ready-to-play Animations
        this.resolvedAnimationTargets = new Map();
        /*
        ...
        */
        this.doPlayImages = function (action) {
            //FIXME: this.PlayGIF(action.subject);
        };
        this.babylonScene = scene;
        AeroBehaviorEngine.customBehaviorRTMPrototype = new RTMCustomBehaviorPrototype();
    }
    AeroBehaviorEngine.prototype.GetRTM = function () {
        return AeroBehaviorEngine.customBehaviorRTMPrototype;
    };
    AeroBehaviorEngine.prototype.SetComponentMap = function (componentMap) {
        this.componentMap = componentMap;
    };
    AeroBehaviorEngine.prototype.startEngine = function (behaviorJSON, sceneParsedCallback) {
        ...
        for (var behaviorI in this.behaviors) {
    ...
    AeroBehaviorEngine.prototype.InitializeBehaviors = function (behaviorJSON, sceneFolderURL, sceneParsedCallback) {
        var _this = this;
        ...
        if (!AeroBehaviorEngine.wasmBehaviorEngine && this.useWASM) {
            ...
            aeroWASM.initAeroBehaviorEngineWASM({}, function (AeroBehaviorEngineFromWASM) {
                console.log("Aero Behavior Engine Initialized!");
                AeroBehaviorEngine.wasmBehaviorEngine = new AeroBehaviorEngineFromWASM();
                _this.startEngine(behaviorJSON, sceneParsedCallback);
            });
        }
        else {
    ...
    AeroBehaviorEngine.prototype.PrepareBehaviors = function (entityMapping) {
        var _this = this;
        this.prepareBehaviors();
        if (this.useWASM) {
            this.resolvedAnimationTargets.forEach(function (targets, animationTargetAsset) {
                targets.forEach(function (animGroup, animationSourceAsset) {
                    var i;
                    var targetedAnimations = animGroup.targetedAnimations;
                    for (i = 0; i < targetedAnimations.length; i++) {
                        var animation = targetedAnimations[i].animation;
                        var targetNode = targetedAnimations[i].target.id;
                        var animationName = targetNode + "_" + animation.name;
                        /*
                        ...
                        */
                        ...
                        for (k = 0; k < keys.length; k++) {
                            if (animation.dataType == babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].ANIMATIONTYPE_VECTOR3) {
                                var vec3Data = keys[k].value;
                                AeroBehaviorEngine.wasmBehaviorEngine.AddVec3Key(animationName, keys[k].frame, vec3Data.x, vec3Data.y, vec3Data.z);
                            }
                            else if (animation.dataType == babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].ANIMATIONTYPE_QUATERNION) {
                                var quatData = keys[k].value;
                        ...
                        entityMapping.forEach(function (entityName, mesh) {
                            var parentName = "none";
                            if (mesh.parent != null) {
            ...
            this.babylonScene.registerBeforeRender(function () {
                if (!AeroBehaviorEngine.wasmBehaviorEngine) {
                    return;
                }
                var camera = _this.babylonScene.activeCamera;
                var anchor = _this.babylonScene.getNodeByName("Ag_Anchor");
    ...
    AeroBehaviorEngine.prototype.OnStart = function () {
        this.start();
    };
    //Stop playing the behaviors
    AeroBehaviorEngine.prototype.release = function () {
        if (AeroBehaviorEngine.wasmBehaviorEngine) {
            AeroBehaviorEngine.wasmBehaviorEngine.delete();
        }
    };
    AeroBehaviorEngine.prototype.RaiseCustomEvent = function (eventName) {
        if (AeroBehaviorEngine.wasmBehaviorEngine) {
            AeroBehaviorEngine.wasmBehaviorEngine.RaiseCustomEvent(eventName);
        }
    };
    //Called by the outside when an entity has been picked
    AeroBehaviorEngine.prototype.OnTap = function (entityName) {
        if (AeroBehaviorEngine.wasmBehaviorEngine) {
            AeroBehaviorEngine.wasmBehaviorEngine.Tap(entityName);
        }
        else {
            var behaviorList = this.tapBehaviors.get(entityName);
            if (behaviorList) {
    ...
    AeroBehaviorEngine.prototype.visitBehaviors = function (func, object) {
        for (var behaviorI in this.rawBehaviors) {
            var behavior = this.rawBehaviors[behaviorI];
    ...
    */
    AeroBehaviorEngine.prototype.prepareBehaviors = function () {
    ...
    */
    //Start playing the behaviors
    AeroBehaviorEngine.prototype.start = function () {
        if (!this.useWASM) {
            for (var behaviorI in this.startBehaviors) {
    ...
    AeroBehaviorEngine.prototype.gatherParallelActions = function (action, actionList) {
    ...
    AeroBehaviorEngine.prototype.getActionSubject = function (action) {
        var subjectName = action.subject;
        var actionSubject = this.babylonScene.getNodeByName(subjectName);
        return actionSubject;
    };
    AeroBehaviorEngine.prototype.executeBehavior = function (behavior) {
    ...
    AeroBehaviorEngine.prototype.RunBehaviorJSON = function (uri) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var assetURL, e_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.componentMap != undefined && this.componentMap.get(uri) != undefined) {
                            assetURL = this.componentMap.get(uri);
                        }
                        if (!Object(babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["IsWindowObjectExist"])()) return [3 /*break*/, 3];
                        return [4 /*yield*/, babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Tools"].LoadScriptAsync(assetURL)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    AeroBehaviorEngine.prototype.parseBehaviorJSON = function (behavior) {
    ...
    */
    AeroBehaviorEngine.prototype.handleAction = function (action) {
        if (action.name == "hide") {
            this.doHide(action);
        }
    ...
    */
    ...
    AeroBehaviorEngine.prototype.GetURLParams = function (myURL) {
        var params = new Map();
        if (myURL.includes("?")) {
    ...
    AeroBehaviorEngine.prototype.doOpenURL = function (action) {
        var _this = this;
        //Example: {"name":"openURL","url":"https://adobeaero.app.link/hjr2kREailb?target=append"}
        if (action.url == undefined) {
            return;
        }
        var params = this.GetURLParams(action.url);
        var replaceScene = true;
        ...
        if (action.url.includes("adobeaero.app.link") && !replaceScene) {
            ...
            var sceneAnchor = this.babylonScene.getNodeByName("Ag_Anchor");
            var scene = sceneAnchor.aeroScene;
            babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["SceneLoader"].ImportMesh(action.url, "", "", this.babylonScene, function () {
                var scene2Anchor = _this.babylonScene.getNodeByName("Ag_Anchor_2");
    ...
    */
    AeroBehaviorEngine.prototype.doHide = function (action) {
    ...
    */
    AeroBehaviorEngine.prototype.doShow = function (action) {
        var actionSubject = this.getActionSubject(action);
        if (actionSubject != undefined) {
    ...
    */
    AeroBehaviorEngine.prototype.doMove = function (action) {
        var actionSubject = this.getActionSubject(action);
        if (actionSubject != undefined) {
            var x = 0;
            var y = 0;
            ...
            var endPosition = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Vector3"](0, 0, 0);
            ...
            if (action.duration < 0.02) {
                ...
                var animation = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].CreateAndStartAnimation("move" + actionSubject.name, actionSubject, "position", 30, 30 * action.duration, startPosition, endPosition, babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].ANIMATIONLOOPMODE_RELATIVE);
                if (animation) {
   ...
   */
    AeroBehaviorEngine.prototype.doBounce = function (action) {
        var actionSubject = this.getActionSubject(action);
        if (actionSubject != undefined) {
            var x = 0;
            var y = 0;
            ...
            if (action.duration < 0.02) {
                ...
                var animation = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].CreateAndStartAnimation("bounce" + actionSubject.name, actionSubject.parent, //Hack because blending isn't working
                "position", 30, 30 * action.duration / 2, startPosition, endPosition, 0); //Animation.ANIMATIONLOOPMODE_RELATIVE);
                if (animation) {
                    animation.enableBlending(0.1);
                }
                setTimeout(function () {
                    var animation2 = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].CreateAndStartAnimation("bounce" + actionSubject.name, actionSubject.parent, //Hack because blending isn't working
                    "position", 30, 30 * action.duration / 2, endPosition, startPosition, babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Animation"].ANIMATIONLOOPMODE_RELATIVE);
                    if (animation2) {
    ...
    AeroBehaviorEngine.prototype.initializeSounds = function () {
        var _this = this;
        this.visitBehaviors(function (behavior, object) {
            if (behavior.action != undefined && behavior.action.name == "playAudio") {
                _this.prepareAudio(behavior.action);
            }
        }, this);
    };
    AeroBehaviorEngine.prototype.prepareAudio = function (action) {
        var mp3Path = this.getSoundPath(action);
        this.sounds.set(mp3Path, new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Sound"](action.audioSourceID + " Sound", mp3Path, this.babylonScene, function () {
            //TODO: Sound loaded - tag as available
        }));
    };
    AeroBehaviorEngine.prototype.getSoundPath = function (action) {
        //{"audioSourceID":"ag_Phone dial.mp3_691587782"}
        var endOfName = action.audioSourceID.lastIndexOf(".mp3") + 4;
        var mp3Name1 = action.audioSourceID.substring(0, endOfName);
        var mp3Name2 = mp3Name1.substring(3);
        var endOfFolder = mp3Name2.lastIndexOf(".mp3");
        var mp3Folder = mp3Name2.substring(0, endOfFolder);
        var partialURL = "Assets/" + mp3Folder + "/" + mp3Name2;
        var mp3Path = this.sceneFolderURL + partialURL;
        if (this.componentMap != undefined) {
            mp3Path = this.componentMap.get(partialURL) + "?extension=.mp3";
        }
        return mp3Path;
    };
    AeroBehaviorEngine.prototype.getSoundForAction = function (action) {
        var mp3Path = this.getSoundPath(action);
        var sound = this.sounds.get(mp3Path);
        return sound;
    };
    AeroBehaviorEngine.prototype.doPlayAudio = function (action) {
        var sound = this.getSoundForAction(action);
        if (sound) {
            // Sound has been downloaded & decoded
            sound.play(); //time, offset, length
        }
    ...
    */
    AeroBehaviorEngine.prototype.doPlayAnimation = function (action) {
        ...
        */
        ...
        var sourceAssetName = action.animationSourceID;
        if (sourceAssetName == undefined) {
            sourceAssetName = subjectName;
        }
        var targets = this.resolvedAnimationTargets.get(subjectName);
        if (targets != undefined) {
            var animGroup = targets.get(sourceAssetName);
    ...
    AeroBehaviorEngine.prototype.addAnimationGroupToEngine = function (subject, group) {
        this.resolvedAnimationTargets.set(subject, group);
    };
    AeroBehaviorEngine.prototype.initializeAnimations = function () {
        var _this = this;
        ...
        this.visitBehaviors(function (behavior, object) {
            if (behavior.action != undefined && behavior.action.name == "playAnimation") {
                ...
                var actionSubject = _this.babylonScene.getNodeByName(behavior.action.subject);
                if (actionSubject != undefined) {
                    var sourceID = behavior.action.animationSourceID;
                    if (sourceID == undefined) {
                        sourceID = behavior.action.subject;
                    }
                    var resolvedGroup = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["AnimationGroup"]("my-animation-group-" + behavior.action.subject + "-" + sourceID);
                    var len1 = _this.babylonScene.animationGroups.length;
                    for (var g = 0; g < len1; g++) {
                        var animGroup = _this.babylonScene.animationGroups[g];
                        ...
                        for (var a = 0; a < len; a++) {
                            ...
                            if (targetName == behavior.action.subject) {
                                ...
                                var parentMesh = _this.recurseParentsAndFindNode(animGroup.targetedAnimations[a].target, behavior.action.subject);
                                if (parentMesh != undefined) {
                                    ...
                                    var sourceMesh = _this.recurseParentsAndFindNode(animGroup.targetedAnimations[a].target, sourceID);
                                    //This anim target has a parent that is the animationSourceID
                                    if (sourceMesh != undefined) {
                                        //Look for it in the subject mesh
                                        var targetMesh = _this.recurseChildrenAndFindNode(actionSubject, targetName);
                                        if (targetMesh) {
                    ...
                    var groupEntry = new Map();
                    groupEntry.set(sourceID, resolvedGroup);
                    _this.addAnimationGroupToEngine(behavior.action.subject, groupEntry);
                    resolvedGroup.goToFrame(0);
                }
            }
        }, this);
    };
    AeroBehaviorEngine.prototype.recurseParentsAndFindNode = function (node, name) {
    ...
    AeroBehaviorEngine.prototype.recurseChildrenAndFindNode = function (node, name) {
    ...
    AeroBehaviorEngine.wasmBehaviorEngine = null;
    AeroBehaviorEngine.customBehaviorRTMPrototype = null;
    return AeroBehaviorEngine;
}());

var AeroVideo = /** @class */ (function () {
    function AeroVideo(scene_i) {
        this.babylonScene = scene_i;
        this.videoExists = false;
        this.videoPlaying = false;
    }
    AeroVideo.prototype.SetVideoTexture = function (meshName, texturePath) {
        if (this.videoExists) {
            return false;
        }
        ...
        if (!this.videoExists && screen && screen.material) {
            ...
            var videoTexture = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["VideoTexture"]("video", texturePath, scene, false, false, 0, { autoPlay: false, autoUpdateTexture: false });
            ...
            material.ambientColor = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_1__["Color3"](1, 1, 1);
            material.unlit = true;
    ...
    AeroVideo.prototype.PlayVideo = function (meshName) {
        if (!this.videoExists) {
            return;
        }
        var scene = this.babylonScene;
        ...
        if (screen) {
            var material = screen.material;
            var videoTexture = material.albedoTexture;
            videoTexture.video.play();
            this.videoPlaying = true;
        }
    };
    AeroVideo.prototype.PauseVideo = function (meshName) {
    ...
    AeroVideo.prototype.IsVideoPlaying = function () {
...
/***/ "./Aero/format/aeroEntity.ts":
/*!***********************************!*\
  !*** ./Aero/format/aeroEntity.ts ***!
  \***********************************/
/*! exports provided: AeroEntity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroEntity", function() { return AeroEntity; });
/* harmony import */ var babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs/Maths/math.vector */ "babylonjs/Maths/math.color");
/* harmony import */ var babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _aeroAsset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aeroAsset */ "./Aero/format/aeroAsset.ts");
/*
...
var AeroEntity = /** @class */ (function () {
    function AeroEntity() {
        this.children = [];
        this.m_canDraw = true;
        this.m_quaternion = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Quaternion"](0, 0, 0, 0);
        this.m_rotation = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
        this.m_scale = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](1, 1, 1);
        this.m_translation = new babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
        this.m_use_quats = false;
        this.m_localName = '';
        // this.m_rotation.impl = [0, 0, 0];
        // this.m_scale.impl = [1, 1, 1];
        // this.m_translation.impl = [0, 0, 0];
        this.m_asset = new _aeroAsset__WEBPACK_IMPORTED_MODULE_1__["AeroAsset"](this);
    }
    AeroEntity.prototype.asset = function () {
        return this.m_asset;
    };
    AeroEntity.prototype.hasParent = function () {
        if (this.m_parent == undefined) {
            return false;
        }
        return true;
    };
    AeroEntity.prototype.globalName = function () {
        if (this.m_parent) {
    ...
    AeroEntity.prototype.localMatrix = function () {
        //const matrix = new Matrix4();
        var matrixT = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Matrix"].Translation(this.translation().x, this.translation().y, this.translation().z);
        var matrixRx = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Matrix"].RotationX(this.rotation().x);
        var matrixRy = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Matrix"].RotationY(this.rotation().y);
        var matrixRz = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Matrix"].RotationZ(this.rotation().z);
        var matrixS = babylonjs_Maths_math_vector__WEBPACK_IMPORTED_MODULE_0__["Matrix"].Scaling(this.scale().x, this.scale().y, this.scale().z);
        return matrixT.multiply(matrixRx).multiply(matrixRy).multiply(matrixRz).multiply(matrixS);
    };
    AeroEntity.prototype.localName = function () {
        return this.m_localName;
    };
    AeroEntity.prototype.parent = function () {
        return this.m_parent;
    };
    AeroEntity.prototype.quaternion = function () {
        return this.m_quaternion;
    };
    AeroEntity.prototype.rotation = function () {
        return this.m_rotation;
    };
    AeroEntity.prototype.scale = function () {
        return this.m_scale;
    };
    AeroEntity.prototype.setLocalName = function (localName) {
        this.m_localName = localName;
    };
    AeroEntity.prototype.canDraw = function () {
        return this.m_canDraw;
    };
    AeroEntity.prototype.setParent = function (parent) {
        if (parent) {
            this.m_parent = parent;
            parent.children.push(this);
        }
    };
    AeroEntity.prototype.setQuaternion = function (quaternion) {
    ...
    AeroEntity.prototype.setRotation = function (rotation) {
    ...
    AeroEntity.prototype.setScale = function (scale) {
        this.m_scale.x = scale[0];
        this.m_scale.y = scale[1];
        this.m_scale.z = scale[2];
    };
    AeroEntity.prototype.setTranslation = function (translation) {
        this.m_translation.x = translation[0];
        this.m_translation.y = translation[1];
        this.m_translation.z = translation[2];
    };
    AeroEntity.prototype.setCanDraw = function (canDraw) {
        this.m_canDraw = canDraw;
    };
    AeroEntity.prototype.translation = function () {
        return this.m_translation;
    };
    AeroEntity.prototype.useQuaternion = function () {
        return this.m_use_quats;
    };
    AeroEntity.prototype.visitChildren = function (func, object) {
        for (var childI in this.children) {
...
/***/ "./Aero/format/aeroEnvironment.ts":
/*!****************************************!*\
  !*** ./Aero/format/aeroEnvironment.ts ***!
  \****************************************/
/*! exports provided: AeroEnvironment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroEnvironment", function() { return AeroEnvironment; });
/* harmony import */ var babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs/Materials/standardMaterial */ "babylonjs/Maths/math.color");
/* harmony import */ var babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var babylonjs_materials_shadowOnly_shadowOnlyMaterial__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babylonjs-materials/shadowOnly/shadowOnlyMaterial */ "babylonjs-materials/shadowOnly/shadowOnlyMaterial");
/* harmony import */ var babylonjs_materials_shadowOnly_shadowOnlyMaterial__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babylonjs_materials_shadowOnly_shadowOnlyMaterial__WEBPACK_IMPORTED_MODULE_1__);
/*
...
var AeroEnvironment = /** @class */ (function () {
    function AeroEnvironment(scene_i) {
        this.foundPlanes = new Map(); //Plane name, plane json
        this.babylonScene = scene_i;
    }
    AeroEnvironment.prototype.InitializeEnvironment = function () {
    };
    AeroEnvironment.prototype.CreateShadowOnlyMaterial = function (name) {
        var scene = this.babylonScene;
        return new babylonjs_materials_shadowOnly_shadowOnlyMaterial__WEBPACK_IMPORTED_MODULE_1__["ShadowOnlyMaterial"](name, scene);
    };
    AeroEnvironment.prototype.UpdateXRPlane = function (plane_i) {
        try {
            var name = "Environment_" + plane_i.id;
            ...
            var plane = plane_i; // a reference to an added plane
            ...
            var points2D = plane.polygonDefinition.map(function (p) { return new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector2"](p.x, p.z); });
            var polygon_triangulation = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["PolygonMeshBuilder"]("name", points2D);
            // build the plane with specific thickness
            var mesh = polygon_triangulation.build();
            //console.log("Plane Found: " + JSON.stringify(plane_i));
            var scaling = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
            var rotationQuaternion = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Quaternion"](0, 0, 0, 0);
            var translation = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
            plane_i.transformationMatrix.decompose(scaling, rotationQuaternion, translation);
            var eulers = rotationQuaternion.toEulerAngles();
            var normals = mesh.getVerticesData(babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["VertexBuffer"].NormalKind);
            var positions = mesh.getVerticesData(babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["VertexBuffer"].PositionKind);
            var indices = mesh.getIndices(false, false);
    ...
    AeroEnvironment.prototype.UpdateXRImageMarker = function (image) {
        try {
            var width = image.realWorldWidth / 2.0;
            var height = image.realWorldWidth / (image.ratio * 2.0);
            var center = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
            var scaling = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
            var rotationQuaternion = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Quaternion"](0, 0, 0, 0);
            var translation = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
    ...
    AeroEnvironment.prototype.UpdatePlane = function (vertices, indices, normals_i, planeName, position, rotation) {
        var environmentMesh = this.babylonScene.getMeshByName(planeName);
        //If mesh doesn't exist, create it and apply a material
        if (!environmentMesh) {
            //console.log("UpdatePlane New: " + planeName);
            environmentMesh = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Mesh"](planeName, this.babylonScene);
            //Material
            //Partially transparent if environment or image marker
            //Invisible if ground
            var environmentMaterial;
            if (planeName.includes("ImageMarker") || planeName.includes("Environment")) {
                environmentMaterial = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["StandardMaterial"](planeName + "mat", this.babylonScene);
            }
            else {
            ...
            environmentMaterial.sideOrientation = babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Mesh"].DOUBLESIDE;
            environmentMaterial.alpha = 0.3;
            environmentMesh.material = environmentMaterial;
        ...
        if (normals_i != null) {
            ...
            normals = [];
            babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["VertexData"].ComputeNormals(vertices, indices, normals, {
                depthSort: true
            });
        }
        //Assign vertex data
        var vertexData = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["VertexData"]();
        vertexData.positions = vertices;
        vertexData.indices = indices;
        vertexData.normals = normals;
        vertexData.applyToMesh(environmentMesh, true);
        //Assign position, rotation, scale
        environmentMesh.scaling = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](1, 1, 1);
        if (rotation == undefined || position == null) {
            environmentMesh.rotation = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
        }
        else {
            environmentMesh.rotation = rotation;
        }
        if (position == undefined || position == null) {
            environmentMesh.position = new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
        }
        else {
    ...
    AeroEnvironment.prototype.AddGroundPlane = function (center, size) {
        var vertices = [];
        ...
        this.UpdatePlane(vertices, indices, null, "Ground", new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0), new babylonjs_Materials_standardMaterial__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0));
    };
    AeroEnvironment.prototype.RemoveAPlane = function (name) {
        var mesh = this.babylonScene.getNodeByName(name);
        if (mesh) {
    ...
    AeroEnvironment.prototype.RemoveAllPlanes = function () {
        var _this = this;
        this.foundPlanes.forEach(function (planeName, planeJSON) {
            _this.RemoveAPlane(planeName);
            _this.foundPlanes.delete(planeName);
        });
        this.foundPlanes = new Map();
    };
...
/***/ "./Aero/format/aeroPublishHelper.ts":
/*!******************************************!*\
  !*** ./Aero/format/aeroPublishHelper.ts ***!
  \******************************************/
/*! exports provided: AeroPublishHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroPublishHelper", function() { return AeroPublishHelper; });
/* harmony import */ var babylonjs_Misc_webRequest__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs/Misc/webRequest */ "babylonjs/Maths/math.color");
/* harmony import */ var babylonjs_Misc_webRequest__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babylonjs_Misc_webRequest__WEBPACK_IMPORTED_MODULE_0__);
/*
...
var AeroPublishHelper = /** @class */ (function () {
    function AeroPublishHelper() {
        //private format: AeroFormat;
        this.gAeroManifestURL = "";
        this.gAeroCpURL = "";
        this.gAeroComponentTemplatePath = "";
        this.gAeroPublicLink = "";
        this.gAeroScenePath = "";
        this.gAeroComponentMap = new Map();
        this.gAeroJSURL = "";
    }
    AeroPublishHelper.prototype.LoadAeroManifest = function (publicLink, cpURL, manifestParsedCallback) {
        this.loadAeroManifest(publicLink, cpURL, manifestParsedCallback);
    };
    //Base function for loading the contents of a URL
    AeroPublishHelper.prototype.loadTextFromURL = function (url, callback) {
        // read text from URL location
        var request = new babylonjs_Misc_webRequest__WEBPACK_IMPORTED_MODULE_0__["WebRequest"]();
    ...
    AeroPublishHelper.prototype.parseManifest = function (mainfestText) {
        //Raw JSON, so these are type any
        var manifestJson = JSON.parse(mainfestText);
        var components = manifestJson.components;
        var children = manifestJson.children;
        //Find the scene component and construct it's URL
        for (var _i = 0, components_1 = components; _i < components_1.length; _i++) {
            var jsonComponent = components_1[_i];
            var componentPath = jsonComponent["path"];
        ...
        for (var _a = 0, children_1 = children; _a < children_1.length; _a++) {
            var jsonChild = children_1[_a];
            var assetPath = jsonChild["path"];
            var grandChildren = jsonChild["children"];
            if (grandChildren != undefined) {
                for (var _b = 0, grandChildren_1 = grandChildren; _b < grandChildren_1.length; _b++) {
                    var jsonGrandchild = grandChildren_1[_b];
                    var grandChildPath = assetPath;
                    grandChildPath += "/" + jsonGrandchild["path"];
                    var subComponents = jsonGrandchild["components"];
                    if (subComponents != undefined) {
                        for (var _c = 0, subComponents_1 = subComponents; _c < subComponents_1.length; _c++) {
                            var jsonComponent = subComponents_1[_c];
                            var subComponentPath = grandChildPath;
                            subComponentPath += "/" + jsonComponent["path"];
                            var componentURL = this.gAeroComponentTemplatePath;
    ...
    AeroPublishHelper.prototype.loadAeroManifest = function (publicLink, cpURL, manifestParsedCallback) {
        ...
        if (this.gAeroCpURL != undefined && !this.gAeroCpURL.includes("CP_URL") && this.gAeroCpURL != "") {
            ...
            this.loadTextFromURL(this.gAeroCpURL, function (componentLinkResponseText) {
                var componentLinkResponseJSON = JSON.parse(componentLinkResponseText);
                var links = componentLinkResponseJSON["_links"];
                _this.gAeroManifestURL = links["dcx_manifest"]["href"];
                _this.gAeroComponentTemplatePath = links["dcx_component"]["href"];
                _this.loadTextFromURL(_this.gAeroManifestURL, _this.parseManifest);
            });
        }
            ...
            var branchKey = 'key_live_cdTvTtwBPh3UQwdZZNlwbbdhqDakuKSj';
            var url = "https://api2.branch.io/v1/url?url=";
            url += this.gAeroPublicLink;
            url += "&branch_key=" + branchKey;
            this.loadTextFromURL(url, function (apiResponseText) {
                var apiResponseJSON = JSON.parse(apiResponseText);
                //console.log(apiResponseText);
                var apiLink = apiResponseJSON.data["aero_pub_url"];
                _this.loadTextFromURL(apiLink, function (apiLinkResponseText) {
                    //console.log(apiLinkResponseText);
                    var apiLinkResponseJSON = JSON.parse(apiLinkResponseText);
                    var componentLink = apiLinkResponseJSON["cp_url"];
                    componentLink += "?api_key=Aero_Content_Service1";
                    _this.loadTextFromURL(componentLink, function (componentLinkResponseText) {
                        //console.log(componentLinkResponseText);
                        var componentLinkResponseJSON = JSON.parse(componentLinkResponseText);
                        var links = componentLinkResponseJSON["_links"];
                        _this.gAeroManifestURL = links["dcx_manifest"]["href"];
                        _this.gAeroComponentTemplatePath = links["dcx_component"]["href"];
                        _this.loadTextFromURL(_this.gAeroManifestURL, function (manifest) {
                            _this.parseManifest(manifest);
                        });
                    });
                });
            });
...
/***/ "./Aero/format/aeroScene.ts":
/*!**********************************!*\
  !*** ./Aero/format/aeroScene.ts ***!
  \**********************************/
/*! exports provided: AeroTask, AeroQueueEntry, AeroScene */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroTask", function() { return AeroTask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroQueueEntry", function() { return AeroQueueEntry; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroScene", function() { return AeroScene; });
/* harmony import */ var _aeroEntity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./aeroEntity */ "./Aero/format/aeroEntity.ts");
/* harmony import */ var _aeroBehaviorEngine__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aeroBehaviorEngine */ "./Aero/format/aeroBehaviorEngine.ts");
/* harmony import */ var _aeroAnchorNode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./aeroAnchorNode */ "./Aero/format/aeroAnchorNode.ts");
/* harmony import */ var _aeroWebXRHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./aeroWebXRHelper */ "./Aero/format/aeroWebXRHelper.ts");
/* harmony import */ var _glTF_glTFFileLoader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../glTF/glTFFileLoader */ "./glTF/glTFFileLoader.ts");
/* harmony import */ var babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! babylonjs/Meshes/transformNode */ "babylonjs/Maths/math.color");
/* harmony import */ var babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__);
/*
...
var AeroQueueEntry = /** @class */ (function () {
    function AeroQueueEntry() {
    ...
    return AeroQueueEntry;
}());

var AeroScene = /** @class */ (function () {
    function AeroScene(scene) {
        this.isDesktop = false;
        this.entityMapping = new Map(); //meshName, entityName
        this.loadingChildScene = false;
        //Asset URLs
        this.viewerAssetPath = "";
        this.iblURL = "";
        this.earcutURL = "";
        this.publishURL = "";
        this.iOSWebXRURL = "";
        this.assetsManager = new Map();
        this.assetsLoaded = 0;
        //Scene size
        this.sceneWidth = 0;
        this.sceneDepth = 0;
        this.sceneHeight = 0;
        this.sceneCenter = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"](0, 0, 0);
        this.sceneBottom = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"](0, 0, 0);
        this.pointerDownPredicate = function (mesh) {
        ...
        this.behaviorEngine = new _aeroBehaviorEngine__WEBPACK_IMPORTED_MODULE_1__["AeroBehaviorEngine"](scene);
        this.webXR = new _aeroWebXRHelper__WEBPACK_IMPORTED_MODULE_3__["AeroWebXRHelper"](scene, this);
        var isDesktop = {
            Mac: function () {
    ...
    //Initialize
    AeroScene.prototype.InitializeSceneLoader = function () {
        babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["SceneLoader"].OnPluginActivatedObservable.add(function (plugin, eventState) {
            if (plugin.name === "gltf" && plugin instanceof _glTF_glTFFileLoader__WEBPACK_IMPORTED_MODULE_4__["GLTFFileLoader"]) {
                //Don't play animations on load
                plugin.animationStartMode = _glTF_glTFFileLoader__WEBPACK_IMPORTED_MODULE_4__["GLTFLoaderAnimationStartMode"].NONE;
            }
        });
    };
    //Play the experience
    AeroScene.prototype.Start = function () {
        this.behaviorEngine.OnStart();
    };
    AeroScene.prototype.GetWebXR = function () {
        return this.webXR;
    };
    AeroScene.prototype.EnterARModeiOS = function () {
        this.webXR.EnterARMode(false);
    };
    AeroScene.prototype.ExitARModeiOS = function () {
        this.webXR.ExitARMode(false);
    };
    AeroScene.prototype.GetEntityMapping = function () {
        return this.entityMapping;
    };
    AeroScene.prototype.GetIBLURL = function () {
        return this.iblURL;
    };
    AeroScene.prototype.GetAssetURL = function (assetName) {
        return this.viewerAssetPath + assetName;
    };
    AeroScene.prototype.GetEarcutURL = function () {
        return this.earcutURL;
    };
    AeroScene.prototype.GetIOSWebXRURL = function () {
        return this.iOSWebXRURL;
    };
    AeroScene.prototype.GetSceneURL = function () {
        return this.sceneURL;
    };
    AeroScene.prototype.GetPublishURL = function () {
        return this.publishURL;
    };
    AeroScene.prototype.SetPublishURL = function (url) {
        this.publishURL = url;
    };
    AeroScene.prototype.SetShadowDirection = function (x, y, z) {
        if (this.shadowLight) {
            this.shadowLight.direction = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"](x, y, z);
        }
    };
    AeroScene.prototype.GetRTM = function () {
        return this.behaviorEngine.GetRTM();
    };
    AeroScene.prototype.RaiseCustomEvent = function (eventName) {
        return this.behaviorEngine.RaiseCustomEvent(eventName);
    };
    AeroScene.prototype.setupPicking = function () {
        var _this = this;
        this.babylonScene.onPointerObservable.add(function (pointerInfo) {
            //pointerInfo.event.preventDefault();
            switch (pointerInfo.type) {
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERDOWN:
                    var pickInfo = _this.babylonScene.pick(pointerInfo.event.x, pointerInfo.event.y, _this.pointerDownPredicate, false, _this.babylonScene.activeCamera);
                    if (pointerInfo && pickInfo) {
                        pointerInfo.pickInfo = pickInfo;
                        if (pointerInfo.pickInfo.pickedMesh != undefined) {
                            var mesh = pointerInfo.pickInfo.pickedMesh;
                            if (_this.childScene && _this.childScene.entityMapping.has(mesh)) {
                                var entityName = _this.childScene.getEntityForMesh(mesh);
                                _this.childScene.behaviorEngine.OnTap(entityName);
                            }
                            else if (_this.entityMapping.has(mesh)) {
                                var entityName = _this.getEntityForMesh(mesh);
                                _this.behaviorEngine.OnTap(entityName);
                            }
                        }
                    }
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERUP:
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERMOVE:
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERWHEEL:
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERPICK:
                    ...
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERTAP:
                    _this.webXR.OnTap();
                    break;
                case babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["PointerEventTypes"].POINTERDOUBLETAP:
                    break;
            }
        });
    };
    AeroScene.prototype.addEntityMapping = function (mesh, name) {
        return this.entityMapping.set(mesh, name);
    };
    AeroScene.prototype.getEntityForMesh = function (mesh) {
        return this.entityMapping.get(mesh);
    };
    AeroScene.prototype.GetImageMarkerURL = function () {
    ...
    AeroScene.prototype.SceneHasImageMarkers = function () {
        if (this.anchorNode.imageMarkerPath != "" && this.anchorNode.imageMarkerPath != undefined) {
            return true;
        }
        return false;
    };
    AeroScene.prototype.GetAnchor = function () {
        return this.anchorNode;
    };
    AeroScene.prototype.ResetCameraAndAnchor = function () {
    ...
    */
    AeroScene.prototype.LoadScene = function (url, componentMap, options) {
        var _this = this;
        if (url == "") {
            return false;
        }
        ...
        this.loadFileFromURL(url, "application/json", function (jsonText) {
            _this.parseAeroScene(jsonText);
        });
        return true;
    };
    AeroScene.prototype.loadFileFromURL = function (file, mimeType, callback) {
        if (file.includes("undefined")) {
            return;
        }
        var request = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["WebRequest"]();
        request.addEventListener("readystatechange", function () {
            if (request.readyState === 4 && (request.status === 200 || request.status === 0)) {
    ...
    AeroScene.prototype.parseAeroScene = function (jsonText) {
        var _this = this;
        this.parseJSON(jsonText, function () {
            var scene = _this.babylonScene;
            if (!scene) {
                return;
            }
            if (!_this.loadingChildScene) {
                if (_this.enableShadows) {
                    //Lights and Shadows
                    _this.shadowLight = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["DirectionalLight"]("DirectionalLight", new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"](0, -10, 0), scene);
                    _this.shadowLight.intensity = 0.0;
                    _this.aeroShadowGenerator = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["ShadowGenerator"](1024, _this.shadowLight);
                    _this.aeroShadowGenerator.useBlurExponentialShadowMap = true;
                }
                var iblTexture = babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["CubeTexture"].CreateFromPrefilteredData(_this.iblURL, scene, ".env");
                scene.environmentTexture = iblTexture;
                scene.environmentIntensity = 1.0;
                scene.clearColor = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Color4"](0, 0, 0, 0);
                //Install an event handler
                _this.setupPicking();
            }
            //Walk the entities we parsed, add them to the download queue
            _this.visitRootEntities(function (entity, object) {
                _this.addEntityToBabylonScene(entity, function (babylonEntityNode, assetURL, entityName, maxDiameter) {
                    //Gets called back for each entity found in the file that has an asset to load
                    _this.addAssetToQueue(babylonEntityNode, assetURL, entityName, maxDiameter);
                });
            }, _this);
        });
    };
    AeroScene.prototype.parseJSON = function (jsonText, sceneParsedCallback) {
        var _this = this;
        var json = JSON.parse(jsonText);
        //this.clear();
        var entityFromJson = function (json, parent) {
            var name = json.name;
            if (name) {
                ...
                var entity = new _aeroEntity__WEBPACK_IMPORTED_MODULE_0__["AeroEntity"]();
                if (name == "ag_anchor") {
                    _this.createAnchor(json);
                }
                else if (uri) {
                    var extension = uri.substring(uri.lastIndexOf(".") + 1);
                    if (extension == "js") {
                        entity = _this.createEntity(name, parent);
                        _this.behaviorEngine.RunBehaviorJSON(uri);
                    }
                    else {
                        entity = _this.createAsset(name, uri, parent);
                        if (json.maxAssetDiameter) {
                            entity.asset().setMaxDiameter(json.maxAssetDiameter);
                        }
                        if (json.bboxMin && json.bboxMax) {
                            var min = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"]();
                            min.x = json.bboxMin[0];
                            min.y = json.bboxMin[1];
                            min.z = json.bboxMin[2];
                            var max = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"]();
            ...
            return new _aeroEntity__WEBPACK_IMPORTED_MODULE_0__["AeroEntity"]();
        };
        if (json) {
            var entities = json.nodes;
            if (entities) {
    ...
    AeroScene.prototype.visitRootEntities = function (func, object) {
    ...
    AeroScene.prototype.addEntityToBabylonScene = function (entity, addNodeCallback) {
        var _this = this;
        ...
        var node = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["TransformNode"](entity.localName(), this.babylonScene);
        //Set parent
        if (entity.parent()) {
        ...
        //Position
        var translationAero = entity.translation();
        var translationArray = translationAero.asArray();
        node.position = babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"].FromArray(translationArray);
        //Rotation
        if (entity.useQuaternion()) {
            var quatAero = entity.quaternion();
            node.rotationQuaternion = babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Quaternion"].FromArray(quatAero.asArray());
        }
        else {
            var rotation = entity.rotation();
            var deg2rad = Math.PI / 180.0;
            // Right to Left handed
            node.rotate(babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Axis"].X, rotation.x * deg2rad, babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Space"].LOCAL);
            node.rotate(babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Axis"].Y, rotation.y * deg2rad, babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Space"].LOCAL);
            node.rotate(babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Axis"].Z, rotation.z * deg2rad, babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Space"].LOCAL);
        }
        //Scale
        var aeroScale = entity.scale();
        node.scaling = babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Vector3"].FromArray(aeroScale.asArray());
        entity.babylon = node;
        //URL
        ...
        entity.visitChildren(function (child, object) {
            _this.addEntityToBabylonScene(child, addNodeCallback);
        }, this);
    };
    AeroScene.prototype.createAsset = function (name, uri, parent) {
        var entity = this.createEntity(name, parent);
        entity.asset().setUri(uri);
        return entity;
    };
    AeroScene.prototype.createEntity = function (name, parent) {
        var entity = new _aeroEntity__WEBPACK_IMPORTED_MODULE_0__["AeroEntity"]();
        if (parent) {
    ...
    AeroScene.prototype.createAnchor = function (anchor) {
        var anchorName = "Ag_Anchor";
        this.loadingChildScene = false;
        var sceneAnchor = this.babylonScene.getNodeByName(anchorName);
        if (sceneAnchor) {
            this.loadingChildScene = true;
            anchorName = "Ag_Anchor_2";
        }
        this.anchorNode = new _aeroAnchorNode__WEBPACK_IMPORTED_MODULE_2__["AeroAnchorNode"](anchorName, this.babylonScene, this);
    ...
    AeroScene.prototype.clear = function () {
    ...
    */
    AeroScene.prototype.addAssetToQueue = function (entityNode, uri, entityName, maxDiameter) {
        var _this = this;
        if (uri) {
            ...
            if (this.queueEmpty == true) {
                ...
                setTimeout(function () {
                    _this.checkAssetQueue();
                }, 1000);
            }
        }
    };
    AeroScene.prototype.checkAssetQueue = function () {
        var _this = this;
        if (this.queueEmpty == true) {
            //Kill the timeout
        ...
        var maxLoading = 1;
        var broken = false;
        this.assetsManager.forEach(function (asset, assetID) {
        ...
        this.assetsManager.forEach(function (asset, assetID) {
            if (!asset.isLoaded && !asset.isLoading && !broken) {
                ...
                if (_this.progressCallback) {
                    _this.progressCallback(true, _this.assetsLoaded, _this.assetsManager.size);
                }
                asset.isLoading = true;
                _this.currentlyLoadingAssetID = assetID;
                babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["SceneLoader"].ImportMesh("", asset.url, "", _this.babylonScene, function (meshes) {
                    var task = new AeroTask();
                    task.name = _this.currentlyLoadingAssetID;
                    task.loadedMeshes = meshes;
                    _this.assetLoaded(task);
                }, function () {
                    //Progress
                }, function () {
                    //Error
            ...
            if (!broken) {
                _this.assetsLoaded = _this.assetsLoaded + 1;
            }
        });
    ...
    AeroScene.prototype.assetLoaded = function (task) {
        var foundRoot = false;
        var asset = this.assetsManager.get(task.name);
        if (!asset) {
            return;
        }
        var maxAssetDiameter = asset.maxDiameter;
        var node = asset.node;
        var adjustment = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["TransformNode"]('adjustment', this.babylonScene);
        ...
        //     addProximity = true;
        // }
        for (var meshI in task.loadedMeshes) {
            var mesh = task.loadedMeshes[meshI];
            //FIXME: (Perf - every mesh?) Only do this if this mesh has an "OnProximity" event
            // if (addProximity) {
            //     this.SetupCollisionDetection(mesh);
            // }
            mesh.cullingStrategy = babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["AbstractMesh"].CULLINGSTRATEGY_BOUNDINGSPHERE_ONLY;
            ...
            if (mesh.parent === null) {
                if (!foundRoot) {
                    foundRoot = true;
                    var bounds = mesh.getHierarchyBoundingVectors();
                    // Parent after the bounds are computed since they happen in world space
                    mesh.parent = adjustment;
                    var radius = Math.max(bounds.max.x - bounds.min.x, bounds.max.y - bounds.min.y, bounds.max.z - bounds.min.z);
                    if (maxAssetDiameter > 0.000001) {
                        var scale = maxAssetDiameter / radius;
    ...
    AeroScene.prototype.onSceneLoaded = function () {
        var _this = this;
        ...
        this.webXR.InitializeWebXR(function () {
            //WebXR is initialized.  Start Behaviors
            _this.Start();
            if (typeof _native !== 'undefined') {
                //For Babylon Native - for now
                _this.webXR.xrHelper.baseExperience.enterXRAsync("immersive-ar", "unbounded", _this.webXR.xrHelper.renderTarget).then(function (xrSessionManager) {
                    ...
                    xrSessionManager.scene.clearColor = new babylonjs_Meshes_transformNode__WEBPACK_IMPORTED_MODULE_5__["Color4"](0, 0, 0, 0);
                });
            }
        });
        //Call back if needed
    ...
    AeroScene.prototype.SetSceneLoadedCallback = function (callback) {
        this.sceneLoadedCallback = callback;
    };
    AeroScene.prototype.SetEnterARCallback = function (callback) {
        this.webXR.SetEnterARCallback(callback);
    };
    AeroScene.prototype.SetExitARCallback = function (callback) {
        this.webXR.SetExitARCallback(callback);
    };
    AeroScene.prototype.GetLoadedMeshes = function () {
        var meshes = new Array();
        this.entityMapping.forEach(function (entity, mesh) {
            meshes.push(mesh);
        });
        return meshes;
    };
    AeroScene.prototype.PlaceScene = function (anchorNode) {
...
/***/ "./Aero/format/aeroWebXRHelper.ts":
/*!****************************************!*\
  !*** ./Aero/format/aeroWebXRHelper.ts ***!
  \****************************************/
/*! exports provided: AeroWebXRHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AeroWebXRHelper", function() { return AeroWebXRHelper; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
/* harmony import */ var babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! babylonjs/XR/features/WebXRImageTracking */ "babylonjs/Maths/math.color");
/* harmony import */ var babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _aeroEnvironment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./aeroEnvironment */ "./Aero/format/aeroEnvironment.ts");
/*
...
var AeroWebXRHelper = /** @class */ (function () {
    function AeroWebXRHelper(scene_i, aeroScene_i) {
        this.mode = "3D";
        this.trackingMode = "plane";
        this.groundOrientation = 1;
        this.imageMesh = "";
        this.checkedImageTracking = false;
        ...
        this.lastPlacementScale = 1;
        this.placementNode = null;
        this.babylonScene = scene_i;
        this.aeroScene = aeroScene_i;
        this.environment = new _aeroEnvironment__WEBPACK_IMPORTED_MODULE_2__["AeroEnvironment"](scene_i);
    }
    AeroWebXRHelper.prototype.GetEnvironment = function () {
        return this.environment;
    };
    AeroWebXRHelper.prototype.MoveAnchor = function (center, normal, rotationAboutNormal, scale) {
        var aeroScene = this.aeroScene;
        var aeroAnchor = this.placementNode;
        if (!aeroAnchor) {
            aeroAnchor = aeroScene.GetAnchor();
        }
        aeroAnchor.scaling = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](scale, scale, scale);
        aeroAnchor.position = center;
        var eulers;
        if (this.groundOrientation == 1) {
            //Calculate X/Z rotation matrix using up vector and surface normal
            var zeroYRotationVector = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](0, 1, 0);
            var normalRotation = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"]();
            babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].FromUnitVectorsToRef(zeroYRotationVector, normal, normalRotation);
            var normalTransformMatrix = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Matrix"]();
            ...
            if (rotationAboutNormal != 0) {
                ...
                var spinQuaternion = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].RotationAxis(normal, rotationAboutNormal);
                var spinTransformMatrix = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Matrix"]();
            ...
            var quat = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].FromRotationMatrix(matrix);
            eulers = quat.toEulerAngles();
        }
        else {
            //Calculate X/Y rotation matrix using out vector and surface normal
            var zeroZRotationVector = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](0, 0, 1);
            var normalRotation = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"]();
            babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].FromUnitVectorsToRef(zeroZRotationVector, normal, normalRotation);
            var normalTransformMatrix = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Matrix"]();
            normalRotation.toRotationMatrix(normalTransformMatrix);
            var matrix = normalTransformMatrix;
            var quat = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].FromRotationMatrix(matrix);
        ...
        if (groundMesh) {
            ...
            groundMesh.scaling = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](scale, scale, scale);
        }
    };
    AeroWebXRHelper.prototype.OnTrackingUpdate = function (mesh, vertexData) {
        var name = mesh.name;
        if (this.trackingMode == "image") {
            this.imageMesh = name;
        }
        var meshBounds = mesh.getHierarchyBoundingVectors();
        var center = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](0, 0, 0);
        ...
        var p1 = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](vertexData.positions[6], vertexData.positions[7], vertexData.positions[8]);
        var p2 = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](vertexData.positions[9], vertexData.positions[10], vertexData.positions[11]);
        var p1W = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].TransformCoordinates(p1, mesh.getWorldMatrix());
        var p2W = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].TransformCoordinates(p2, mesh.getWorldMatrix());
        x2 = (p1W.x + p2W.x) / 2;
        y2 = (p1W.y + p2W.y) / 2;
        z2 = (p1W.z + p2W.z) / 2;
        var n1 = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](vertexData.normals[0], vertexData.normals[1], vertexData.normals[2]);
        normal = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].TransformNormal(n1, mesh.getWorldMatrix());
        //}
        normal.normalize();
        //Calculate Y rotation using Image Z vector and Identity Z Vector
        var zeroRotationZVector = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](0, 0, 1);
        var planeCenterZVector = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](-(x2 - center.x), (y2 - center.y), (z2 - center.z));
        planeCenterZVector.normalize();
        var q = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"]();
        babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Quaternion"].FromUnitVectorsToRef(zeroRotationZVector, planeCenterZVector, q);
        var eulersFromCenterZVector = q.toEulerAngles();
        var angleHeading = -eulersFromCenterZVector.y - Math.PI / 2;
        var scale = 1.0;
    ...
    */
    AeroWebXRHelper.prototype.SetCamera = function (px, py, pz, ox, oy, oz, minZ, maxZ, hFov) {
        if (!this.babylonScene) {
            return;
        }
        var camera = this.babylonScene.activeCamera;
        if (!camera) {
            return;
        }
    ...
    AeroWebXRHelper.prototype.SetEnterARCallback = function (callback) {
        this.enterARCallback = callback;
    };
    AeroWebXRHelper.prototype.SetExitARCallback = function (callback) {
        this.exitARCallback = callback;
    };
    AeroWebXRHelper.prototype.ManageModes = function () {
        var _this = this;
        this.xrHelper.baseExperience.onStateChangedObservable.add(function (state) {
            switch (state) {
                case babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRState"].IN_XR:
                    break;
                case babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRState"].ENTERING_XR:
                    _this.EnterARMode(true);
                    break;
                case babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRState"].EXITING_XR:
                    break;
                case babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRState"].NOT_IN_XR:
                    _this.ExitARMode(true);
                    break;
            }
        });
    };
    AeroWebXRHelper.prototype.EnterARMode = function (fromWebXR) {
        this.mode = "AR";
    ...
    AeroWebXRHelper.prototype.OnTap = function () {
    ...
    AeroWebXRHelper.prototype.HideScene = function () {
        this.GetAnchor().setEnabled(false);
    };
    AeroWebXRHelper.prototype.ShowScene = function () {
        this.GetAnchor().setEnabled(true);
    };
    AeroWebXRHelper.prototype.GetAnchor = function () {
        if (this.placementNode != null) {
            return this.placementNode;
        }
        return this.aeroScene.GetAnchor();
    };
    AeroWebXRHelper.prototype.PlaceScene = function (anchorNode) {
        if (this.mode == "AR") {
    ...
    AeroWebXRHelper.prototype.SetAnchor = function () {
        //Shut down XR
        this.StopHitTesting();
        this.StopImageTracking();
        this.StopPlaneTracking();
        ...
        if (this.placementNode != null) {
            var scene = this.placementNode.aeroScene;
            this.placementNode = null;
            scene.Start();
        }
        else {
    ...
    AeroWebXRHelper.prototype.ExitARMode = function (fromWebXR) {
        var aeroScene = this.aeroScene;
        this.anchorSet = false;
        this.mode = "3D";
        this.environment.RemoveAllPlanes();
    ...
    AeroWebXRHelper.prototype.AutoScale = function () {
    ...
    */
    AeroWebXRHelper.prototype.IsWebXRAvailable = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var arAvailable;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // }
                        this.webXRAvailable = true;
                        return [4 /*yield*/, babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRSessionManager"].IsSessionSupportedAsync('immersive-ar')];
                    case 1:
                        arAvailable = _a.sent();
                        if (!arAvailable) {
    ...
    AeroWebXRHelper.prototype.ARSupported = function () {
        // if (this.IsAeroMessageHandlerAvailable()) {
    ...
    AeroWebXRHelper.prototype.InitializeWebXR = function (callback) {
        // if (this.IsAeroMessageHandlerAvailable()) {
        //     console.log("Running on iOS with host app providing AR");
        //     this.webXRAvailable = true;
        //     return;
        ...
        try {
            this.babylonScene.createDefaultXRExperienceAsync({
                ...
                disableDefaultUI: (typeof _native !== undefined),
                ...
                if (!xrHelper || !xrHelper.baseExperience || !xrHelper.baseExperience.sessionManager) {
                    _this.webXRAvailable = false;
                    callback(false);
                    return;
                }
                //WebXR default experience successfull initialized
                _this.xrHelper = xrHelper;
                _this.sessionManager = _this.xrHelper.baseExperience.sessionManager;
                _this.InitializePlaneTracking();
                _this.InitializeHitTesting();
                _this.ManageModes();
                callback(true);
            }, function (error) {
                // no xr...
    ...
    /*
        Image Tracking
    */
    AeroWebXRHelper.prototype.ImageTrackingAvailable = function () {
        ...
        var relativePath = "";
        var physicalWidth = 1.0;
        var fm = this.xrHelper.baseExperience.featuresManager;
        this.imageTracking = null;
        try {
            this.imageTracking = fm.enableFeature(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRImageTracking"].Name, 'latest', {
                images: [
                    {
                        src: relativePath,
    ...
    AeroWebXRHelper.prototype.StartWebXRImageTracking = function (relativePath, physicalWidth) {
        var _this = this;
        if (this.xrHelper == undefined) {
            return;
        }
        ...
        if (this.imageTracking) {
            this.imageTracking.onUntrackableImageFoundObservable.add(function (idx) {
                console.log('Aero cannot track this image', idx);
                _this.HideScene();
            });
            this.imageTracking.onTrackableImageFoundObservable.add(function (image) {
            });
            this.imageTracking.onTrackedImageUpdatedObservable.add(function (image) {
                _this.ShowScene();
                var plane = _this.environment.UpdateXRImageMarker(image);
                //TODO - if hit test system is working, use that for consistency
                _this.OnTrackingUpdate(plane.mesh, plane.vertexData);
            });
        }
    };
    AeroWebXRHelper.prototype.StopImageTracking = function () {
        ...
        if (this.imageMesh != "") {
            var mesh = this.babylonScene.getMeshByName(this.imageMesh);
            if (mesh) {
                mesh.setEnabled(false);
                mesh.dispose();
            }
    ...
    */
    AeroWebXRHelper.prototype.InitializePlaneTracking = function () {
        var _this = this;
        try {
            // featuresManager from the base webxr experience helper
            var fm = this.xrHelper.baseExperience.featuresManager;
            this.planeDetector = fm.enableFeature(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRPlaneDetector"].Name, "latest");
            //Plane tracking succeeded.  We need earcut to make polygons out of plane data
            var earcutURL = this.aeroScene.GetEarcutURL();
            if (Object(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["IsWindowObjectExist"])()) {
                babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Tools"].LoadScriptAsync(earcutURL);
            }
            else {
            ...
            if (this.planeDetector) {
                this.planeDetector.onPlaneAddedObservable.add(function (plane) {
                    _this.environment.UpdateXRPlane(plane);
                });
                this.planeDetector.onPlaneRemovedObservable.add(function (plane) {
                    var name = "Environment_" + plane.id;
                    _this.environment.RemoveAPlane(name);
                });
                this.planeDetector.onPlaneUpdatedObservable.add(function (plane) {
                    _this.environment.UpdateXRPlane(plane);
                });
            }
        }
    ...
    AeroWebXRHelper.prototype.StopPlaneTracking = function () {
        //Shut down hit testing
        if (this.planeDetector) {
    ...
    */
    AeroWebXRHelper.prototype.InitializeHitTesting = function () {
        var _this = this;
        try {
            this.hitTestSystem = this.xrHelper.baseExperience.featuresManager.enableFeature(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["WebXRHitTest"].Name, 'latest', { disablePermanentHitTest: (typeof _native !== undefined) });
        }
        catch (e) {
        }
        if (this.hitTestSystem) {
            this.hitTestSystem.onHitTestResultObservable.add(function (results) {
                if (results == undefined || results.length == 0) {
                    return;
                }
                var camera = _this.xrHelper.baseExperience.camera;
                var normal = babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].TransformNormal(babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].Up(), results[0].transformationMatrix).normalize();
                var position = results[0].position;
                _this.OnHitTestResult(position, normal, camera);
            });
        }
    };
    AeroWebXRHelper.prototype.OnHitTestResult = function (position, normal, camera) {
        ...
        var aeroScene = this.aeroScene;
        var pickx = position.x;
        var picky = position.y;
        var pickz = position.z;
        var picknx = normal.x;
        var pickny = normal.y;
        var picknz = normal.z;
        var pickPoint = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](pickx, picky, pickz);
        var pickNormal = new babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"](picknx, pickny, picknz);
        //Scale based on distance to the camera
        var scale = this.lastPlacementScale;
        if (this.mustAutoScale == true) {
            this.mustAutoScale = false;
            this.isAutoScaled = true;
            this.mustResetScale = false;
            scale = 0.5 * babylonjs_XR_features_WebXRImageTracking__WEBPACK_IMPORTED_MODULE_1__["Vector3"].Distance(camera.position, pickPoint) / aeroScene.sceneWidth;
            if (scale > 1.0) {
                scale = 1.0;
            }
        }
    ...
    AeroWebXRHelper.prototype.StopHitTesting = function () {
        //Shut down hit testing
        if (this.hitTestSystem) {
    ...
    */
    AeroWebXRHelper.prototype.IsAeroMessageHandlerAvailable = function () {
        var isIOS = false;
        ...
        var windowVariant = window;
        var webkit = windowVariant.webkit;
    ...
    AeroWebXRHelper.prototype.SendAeroCommand = function (command) {
        if (!this.IsAeroMessageHandlerAvailable()) {
            return;
        }
        var windowVariant = window;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _aeroLoadingOptions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./aeroLoadingOptions */ "./Aero/aeroLoadingOptions.ts");
/* empty/unused harmony star reexport *//* harmony import */ var _aeroFileLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aeroFileLoader */ "./Aero/aeroFileLoader.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AeroFileLoader", function() { return _aeroFileLoader__WEBPACK_IMPORTED_MODULE_1__["AeroFileLoader"]; });
...
/*!******************!*\
  !*** ./index.ts ***!
  \******************/
/*! exports provided: GLTFLoaderCoordinateSystemMode, GLTFLoaderAnimationStartMode, GLTFLoaderState, GLTFFileLoader, GLTFValidation, GLTF1, GLTF2, MTLFileLoader, SolidParser, OBJFileLoader, STLFileLoader, AeroFileLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Aero_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Aero/index */ "./Aero/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AeroFileLoader", function() { return _Aero_index__WEBPACK_IMPORTED_MODULE_3__["AeroFileLoader"]; });
...
module.exports = __WEBPACK_EXTERNAL_MODULE_babylonjs_materials_shadowOnly_shadowOnlyMaterial__;
